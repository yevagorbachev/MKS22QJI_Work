...
const animate = function(animation) {
	let ret = function(e) {
		...
		animation(e);
		circle_animation_id = window.requestAnimationFrame(animate(animation));
	}		
	return ret;
}
...
stop_button.addEventListener("click", stop_anim(circle_animation_id));